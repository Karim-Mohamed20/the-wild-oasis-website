...
function CabinCard({ cabin }) {
  ...
  return (
    <div className="flex flex-col md:flex-row border-primary-800 border">
      <div className="relative h-52 sm:h-64 md:h-auto md:flex-1">
        <Image
          src={image}
          fill
          alt={`Cabin ${name}`}
      ...
      <div className="flex-grow">
        ...
        <div className="bg-primary-950 border-t border-t-primary-800 text-right">
          <Link
            href={`/cabins/${id}`}
            className="md:border-l border-primary-800 py-3 sm:py-4 px-4 sm:px-6 inline-block text-sm sm:text-base hover:bg-accent-600 transition-all hover:text-primary-900"
          >
